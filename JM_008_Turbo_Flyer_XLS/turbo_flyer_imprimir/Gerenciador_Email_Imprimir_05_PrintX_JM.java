 ...
 * @author i
 */
public class Gerenciador_Email_Imprimir_05_PrintX_JM implements Printable {
    PrinterJob pJob2;
    ...
    public Gerenciador_Email_Imprimir_05_PrintX_JM( JEditorPane pane, PrinterJob pJob, PrintRequestAttributeSet aset ) { try { 
