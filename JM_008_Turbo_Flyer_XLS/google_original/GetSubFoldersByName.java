...
public class GetSubFoldersByName {
    ...
    public static void listar_folders_rootByName(String procurarfolderName) throws IOException {
 
        List<File> rootGoogleFolders = getGoogleRootFoldersByName( procurarfolderName );
