...
public class GetSubFolders {
    ...
    public static final List<File> getGoogleSubFile(String googleFolderIdParent) throws IOException {
    ...
    // com.google.api.services.drive.model.File
    public static final List<File> getGoogleSubFile2(String googleFolderIdParent) throws IOException {
...
do {
  ...
  pageToken = result.getNextPageToken();
    ...
    public static void listar_folders_root() throws IOException {
